...
impl<S> App<S> {
    ...
    where
        ...
        T::Factory:
            NewService<Request = Request, Response = Response, Error = Error> + 'static,
...
struct HttpNewService<T: NewService<Request = Request, Error = Error>>(T);
...
where
    T::Response: 'static,
    T::Future: 'static,
    T: Service<Request = Request, Response = Response, Error = Error> + HttpService,
{
    type Request = Request;
    type Response = T::Response;
    type Error = ();
